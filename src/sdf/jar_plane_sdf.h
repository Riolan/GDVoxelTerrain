...
public:
    JarPlaneSdf() : _normal(0.0f, 0.0f, 0.0f), _d(0.0f) {}
    void set_normal(const Vector3 &normal) { _normal = glm::vec3(normal.x, normal.y, normal.z); }
    Vector3 get_normal() const { return Vector3(_normal.x, _normal.y, _normal.z); }
